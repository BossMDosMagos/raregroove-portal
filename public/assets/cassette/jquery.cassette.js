...
( function( window, $, undefined ) {
	...
	$.Cassette.prototype 	= {
		...
		_createControls		: function() {
			...
			this.$cPlay		= $( '<li class="vc-control-play"><span></span>Play</li>' );
			this.$cRewind	= $( '<li class="vc-control-rewind"><span></span>Rew</li>' );
			this.$cForward	= $( '<li class="vc-control-fforward"><span></span>FF</li>' );
			this.$cStop		= $( '<li class="vc-control-stop"><span></span>Stop</li>' );
			this.$cSwitch	= $( '<li class="vc-control-switch">Switch</li>' );
	...
	$.Song.prototype 		= {
		...
		this.sources	= {
			mp3	: '/assets/cassette/songs/' + this.name + '.mp3',
			ogg	: '/assets/cassette/songs/' + this.name + '.ogg'
		};
	...
	$.Sound.prototype		= {
		...
		getSource			: function( type ) {
			...
			return '/assets/cassette/sounds/' + this.action + '.' + type;
